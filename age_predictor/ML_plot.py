...
class MLPlot():
    ...
    def plot_pca(self, x1, x2, scale=None, component=3, figsize=None, elev=0, azim=0, project=False,
                 save_path='./data'):
        ...
        if component == 3:
            ...
            if project:
                ...
                ax.scatter(np.full(xpca2[:, 0].shape, np.min(xpcat[:, 0]) - disx), xpca2[:, 1], xpca2[:, 2],
                           **scatter_param, c='blue', label='Validation set')
                ...
                ax.scatter(xpca2[:, 0], xpca2[:, 1], xpca2[:, 2], **scatter_param, c='blue', label='Validation set')
        ...
        if component == 2:
            ...
            plt.scatter(xpca2[:, 0], xpca2[:, 1], c='blue', label='Validation set 1', **scatter_param)
